    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 15px; font-size:16pt;">
            <div class="container-fluid">
              <a class="navbar-brand logo" href="{{route('indice')}}">SCAA</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('entidade.index')}}">Entidades</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('coleta.index')}}">Coletas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{route('item.index')}}">Itens</a>
                  </li>
                  @guest
                    @if (Route::has('login'))
                      <li class="nav-item">
